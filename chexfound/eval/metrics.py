...
from torchmetrics.classification import (MultilabelAUROC, MultilabelF1Score, MultilabelAccuracy, MulticlassF1Score, 
                                        ...
                                        JaccardIndex, MulticlassJaccardIndex, BinaryAUROC, MultilabelAveragePrecision,
                                        BinaryAccuracy)
...
def build_topk_accuracy_metric(average_type: MetricAveraging, num_classes: int, ks: tuple = (1, 4)):
    metrics: Dict[str, Metric] = {
...
def build_topk_imagenet_real_accuracy_metric(num_classes: int, ks: tuple = (1, 4)):
